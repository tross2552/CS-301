...
public interface Robot {
	 ...
	 * The particular energy consumption is device dependent such that a call for distance2Obstacle 
	 * may use less energy than a move forward operation.
	 * If battery level is less then or equal to 0 then robot stops to function and hasStopped() is true.
	 * @return current battery level, level is greater than 0 if operational. 
	 */
