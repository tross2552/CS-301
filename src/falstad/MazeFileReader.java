...
public class MazeFileReader {
	...
	// change these into equals and compare methods for the corresponding Maze and BSPNode classes
	// create junit test class that is a subclass of MazeFileReader that takes this code and performs unit tests
	/**
