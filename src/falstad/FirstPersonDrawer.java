...
public class FirstPersonDrawer extends DefaultViewer {
	...
	private void drawBackground(Graphics gc) {
		...
		File file = new File(workingdir+"/Pictures/sky.jpg") ;
		...
		gc.drawImage(image, 0, 0, view_width, view_height/2, 0, 0, image.getWidth(), image.getHeight(), null);
		gc.setColor(new Color(100,200,100));
