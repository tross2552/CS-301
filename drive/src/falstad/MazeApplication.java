...
public class MazeApplication extends JFrame {
	...
	private ModifiedKeyListener kl ;
	...
	private void init() {
		...
		//20171011 Changed this to use Modified Key Listener rather than Simple Key Listener
		kl = new ModifiedKeyListener(this, controller) ;
		addKeyListener(kl) ;
		
		MazeController.app = this;
		MazeView view = new MazeView(controller);
		view.listener = kl;
		MazePanel.setTitlePanel(controller, kl);
		add(MazePanel.getTitlePanel());
