...
public class ModifiedKeyListener implements KeyListener {
	...
	/**This method resets the driver and starts it*/
	...
	/**This method starts the driver if the driver is not manual. It resets the robot,
	 * and then it drives it the the exit. */
