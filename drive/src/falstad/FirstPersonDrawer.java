...
public class FirstPersonDrawer extends DefaultViewer {
	...
	private MazePanel panel ; // the graphics object for the buffer image this class draws on
	 ...
	 */
	@Override
	public void redraw(MazePanel pane, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {
	 ...
	 * @param gc
	 */
	private void drawBackground(MazePanel pane) {
		pane.setColor(pane.lightBlue);
		pane.fillRect(0, 0, view_width, view_height/2);
		pane.setColor(pane.floor);
		pane.fillRect(0, view_height/2, view_width, view_height/2);
	}
	/**
